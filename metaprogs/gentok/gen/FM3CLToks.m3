...
; PROCEDURE Image ( TokNo : TokTyp ) : TEXT 
  ...
  = BEGIN 
      ...
      | 10 => RETURN "disasm"
      | 11 => RETURN "dump-exprs"
      | 12 => RETURN "keep-passes"
      | 13 => RETURN "keep"
      | 14 => RETURN "check-overflow"
      | 15 => RETURN "remove-unused-decls"
      | 16 => RETURN "stderr"
      | 17 => RETURN "log"
      | 18 => RETURN "stdout"
      | 19 => RETURN "unit-log"
...
; PROCEDURE Name ( TokNo : TokTyp ) : TEXT 
  ...
  = BEGIN 
      ...
      | 10 => RETURN "CltDisAsm"
      | 11 => RETURN "CltDumpExprs"
      | 12 => RETURN "CltKeepPasses"
      | 13 => RETURN "CltKeep"
      | 14 => RETURN "CltOvflo"
      | 15 => RETURN "CltRemoveUnusedDecls"
      | 16 => RETURN "CltStdErr"
      | 17 => RETURN "CltFM3Log"
      | 18 => RETURN "CltStdOut"
      | 19 => RETURN "CltUnitLog"
      ELSE RETURN "<Undef>"
      END (*CASE*) 
    END Name
