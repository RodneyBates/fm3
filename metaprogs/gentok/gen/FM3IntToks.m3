...
; PROCEDURE Name ( TokNo : TokTyp ) : TEXT 
  ...
  = BEGIN 
      ...
      | 202 => RETURN "ItkBlockBEGIN"
      | 203 => RETURN "ItkBlockBEGINTemp"
      | 204 => RETURN "ItkBlockBEGINPatch"
      ...
      | 210 => RETURN "ItkTypeDeclEquals"
      | 211 => RETURN "ItkTypeDeclEqualsTemp"
      | 212 => RETURN "ItkTypeDeclEqualsPatch"
