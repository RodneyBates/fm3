...
; CONST ItkFieldDeclListLt              (*ArgCt: 3*) =   327 (*16_c7 02 *)
; CONST ItkFieldDeclListLtTemp          (*ArgCt: 3*) =   328 (*16_c8 02 *)
; CONST ItkFieldDeclListLtPatch         (*ArgCt: 3*) =   329 (*16_c9 02 *)
; CONST ItkFieldDeclListRt              (*ArgCt: 3*) =   330 (*16_ca 02 *)

; CONST ItkFieldDeclListSep             (*ArgCt: 3*) =   331 (*16_cb 02 *)
; CONST ItkFieldDeclListSepTemp         (*ArgCt: 3*) =   332 (*16_cc 02 *)
; CONST ItkFieldDeclListSepPatch        (*ArgCt: 3*) =   333 (*16_cd 02 *)

; CONST ItkFieldDeclListElem            (*ArgCt: 3*) =   334 (*16_ce 02 *)

(* LIST ItkVarDeclList: *)
; CONST ItkVarDeclListLt                (*ArgCt: 3*) =   335 (*16_cf 02 *)
; CONST ItkVarDeclListLtTemp            (*ArgCt: 3*) =   336 (*16_d0 02 *)
; CONST ItkVarDeclListLtPatch           (*ArgCt: 3*) =   337 (*16_d1 02 *)
; CONST ItkVarDeclListRt                (*ArgCt: 3*) =   338 (*16_d2 02 *)

; CONST ItkVarDeclListSep               (*ArgCt: 3*) =   339 (*16_d3 02 *)
; CONST ItkVarDeclListSepTemp           (*ArgCt: 3*) =   340 (*16_d4 02 *)
; CONST ItkVarDeclListSepPatch          (*ArgCt: 3*) =   341 (*16_d5 02 *)

; CONST ItkVarDeclListElem              (*ArgCt: 3*) =   342 (*16_d6 02 *)

(* LIST ItkTypeDeclList: *)
; CONST ItkTypeDeclListLt               (*ArgCt: 3*) =   343 (*16_d7 02 *)
; CONST ItkTypeDeclListLtTemp           (*ArgCt: 3*) =   344 (*16_d8 02 *)
; CONST ItkTypeDeclListLtPatch          (*ArgCt: 3*) =   345 (*16_d9 02 *)
; CONST ItkTypeDeclListRt               (*ArgCt: 3*) =   346 (*16_da 02 *)

; CONST ItkTypeDeclListSep              (*ArgCt: 3*) =   347 (*16_db 02 *)
; CONST ItkTypeDeclListSepTemp          (*ArgCt: 3*) =   348 (*16_dc 02 *)
; CONST ItkTypeDeclListSepPatch         (*ArgCt: 3*) =   349 (*16_dd 02 *)

; CONST ItkTypeDeclListElem             (*ArgCt: 3*) =   350 (*16_de 02 *)

(* LIST ItkMethodDeclList: *)
; CONST ItkMethodDeclListLt             (*ArgCt: 3*) =   351 (*16_df 02 *)
; CONST ItkMethodDeclListLtTemp         (*ArgCt: 3*) =   352 (*16_e0 02 *)
; CONST ItkMethodDeclListLtPatch        (*ArgCt: 3*) =   353 (*16_e1 02 *)
; CONST ItkMethodDeclListRt             (*ArgCt: 3*) =   354 (*16_e2 02 *)

; CONST ItkMethodDeclListSep            (*ArgCt: 3*) =   355 (*16_e3 02 *)
; CONST ItkMethodDeclListSepTemp        (*ArgCt: 3*) =   356 (*16_e4 02 *)
; CONST ItkMethodDeclListSepPatch       (*ArgCt: 3*) =   357 (*16_e5 02 *)

; CONST ItkMethodDeclListElem           (*ArgCt: 3*) =   358 (*16_e6 02 *)

(* LIST ItkOverrideList: *)
; CONST ItkOverrideListLt               (*ArgCt: 3*) =   359 (*16_e7 02 *)
; CONST ItkOverrideListLtTemp           (*ArgCt: 3*) =   360 (*16_e8 02 *)
; CONST ItkOverrideListLtPatch          (*ArgCt: 3*) =   361 (*16_e9 02 *)
; CONST ItkOverrideListRt               (*ArgCt: 3*) =   362 (*16_ea 02 *)

; CONST ItkOverrideListSep              (*ArgCt: 3*) =   363 (*16_eb 02 *)
; CONST ItkOverrideListSepTemp          (*ArgCt: 3*) =   364 (*16_ec 02 *)
; CONST ItkOverrideListSepPatch         (*ArgCt: 3*) =   365 (*16_ed 02 *)

; CONST ItkOverrideListElem             (*ArgCt: 3*) =   366 (*16_ee 02 *)

(* One field decl, with possibly multiple idents. *)
(* Position of LM ident (Lt) or position of semicolon (Rt). *)
(* FIXED ItkFieldDecl: *)
; CONST ItkFieldDeclLt                  (*ArgCt: 2*) =   367 (*16_ef 02 *)
; CONST ItkFieldDeclLtTemp              (*ArgCt: 2*) =   368 (*16_f0 02 *)
; CONST ItkFieldDeclLtPatch             (*ArgCt: 2*) =   369 (*16_f1 02 *)
; CONST ItkFieldDeclRt                  (*ArgCt: 2*) =   370 (*16_f2 02 *)

(* Position of colon. *)
; CONST ItkFieldDeclType                (*ArgCt: 2*) =   371 (*16_f3 02 *)
; CONST ItkFieldDeclTypeTemp            (*ArgCt: 2*) =   372 (*16_f4 02 *)
; CONST ItkFieldDeclTypePatch           (*ArgCt: 2*) =   373 (*16_f5 02 *)

(* Position of becomes. *)
; CONST ItkFieldDeclVal                 (*ArgCt: 2*) =   374 (*16_f6 02 *)
; CONST ItkFieldDeclValTemp             (*ArgCt: 2*) =   375 (*16_f7 02 *)
; CONST ItkFieldDeclValPatch            (*ArgCt: 2*) =   376 (*16_f8 02 *)

(* One variable decl, with possibly multiple idents. *)
(* Position of LM ident (Lt) or position of semicolon (Rt). *)
(* FIXED ItkVarDecl: *)
; CONST ItkVarDeclLt                    (*ArgCt: 2*) =   377 (*16_f9 02 *)
; CONST ItkVarDeclLtTemp                (*ArgCt: 2*) =   378 (*16_fa 02 *)
; CONST ItkVarDeclLtPatch               (*ArgCt: 2*) =   379 (*16_fb 02 *)
; CONST ItkVarDeclRt                    (*ArgCt: 2*) =   380 (*16_fc 02 *)

(* Position of colon. *)
; CONST ItkVarDeclType                  (*ArgCt: 2*) =   381 (*16_fd 02 *)
; CONST ItkVarDeclTypeTemp              (*ArgCt: 2*) =   382 (*16_fe 02 *)
; CONST ItkVarDeclTypePatch             (*ArgCt: 2*) =   383 (*16_ff 02 *)

(* Position of becomes. *)
; CONST ItkVarDeclVal                   (*ArgCt: 2*) =   384 (*16_80 03 *)
; CONST ItkVarDeclValTemp               (*ArgCt: 2*) =   385 (*16_81 03 *)
; CONST ItkVarDeclValPatch              (*ArgCt: 2*) =   386 (*16_82 03 *)

(* LONE ItkDeclTypeAbsent: *)
; CONST ItkDeclTypeAbsent               (*ArgCt: 0*) =   387 (*16_83 03 *)
(* LONE ItkDeclValAbsent: *)
; CONST ItkDeclValAbsent                (*ArgCt: 0*) =   388 (*16_84 03 *)
(* One formal, with possibly multiple idents. *)
(* Position of LM ident (Lt) or of semicolon (Rt). *)
(* FIXED ItkVALUEFormal: *)
; CONST ItkVALUEFormalLt                (*ArgCt: 2*) =   389 (*16_85 03 *)
; CONST ItkVALUEFormalLtTemp            (*ArgCt: 2*) =   390 (*16_86 03 *)
; CONST ItkVALUEFormalLtPatch           (*ArgCt: 2*) =   391 (*16_87 03 *)
; CONST ItkVALUEFormalRt                (*ArgCt: 2*) =   392 (*16_88 03 *)

(* Position of colon. *)
; CONST ItkVALUEFormalType              (*ArgCt: 2*) =   393 (*16_89 03 *)
; CONST ItkVALUEFormalTypeTemp          (*ArgCt: 2*) =   394 (*16_8a 03 *)
; CONST ItkVALUEFormalTypePatch         (*ArgCt: 2*) =   395 (*16_8b 03 *)

(* Position of becomes. *)
; CONST ItkVALUEFormalVal               (*ArgCt: 2*) =   396 (*16_8c 03 *)
; CONST ItkVALUEFormalValTemp           (*ArgCt: 2*) =   397 (*16_8d 03 *)
; CONST ItkVALUEFormalValPatch          (*ArgCt: 2*) =   398 (*16_8e 03 *)

(* One formal, with possibly multiple idents. *)
(* Position of LM ident (Lt) or of semicolon (Rt). *)
(* FIXED ItkVARFormal: *)
; CONST ItkVARFormalLt                  (*ArgCt: 2*) =   399 (*16_8f 03 *)
; CONST ItkVARFormalLtTemp              (*ArgCt: 2*) =   400 (*16_90 03 *)
; CONST ItkVARFormalLtPatch             (*ArgCt: 2*) =   401 (*16_91 03 *)
; CONST ItkVARFormalRt                  (*ArgCt: 2*) =   402 (*16_92 03 *)

(* Position of colon. *)
; CONST ItkVARFormalType                (*ArgCt: 2*) =   403 (*16_93 03 *)
; CONST ItkVARFormalTypeTemp            (*ArgCt: 2*) =   404 (*16_94 03 *)
; CONST ItkVARFormalTypePatch           (*ArgCt: 2*) =   405 (*16_95 03 *)

(* Position of becomes. *)
; CONST ItkVARFormalVal                 (*ArgCt: 2*) =   406 (*16_96 03 *)
; CONST ItkVARFormalValTemp             (*ArgCt: 2*) =   407 (*16_97 03 *)
; CONST ItkVARFormalValPatch            (*ArgCt: 2*) =   408 (*16_98 03 *)

(* One formal, with possibly multiple idents. *)
(* Position of LM ident (Lt) or of semicolon (Rt). *)
(* FIXED ItkROFormal: *)
; CONST ItkROFormalLt                   (*ArgCt: 2*) =   409 (*16_99 03 *)
; CONST ItkROFormalLtTemp               (*ArgCt: 2*) =   410 (*16_9a 03 *)
; CONST ItkROFormalLtPatch              (*ArgCt: 2*) =   411 (*16_9b 03 *)
; CONST ItkROFormalRt                   (*ArgCt: 2*) =   412 (*16_9c 03 *)

(* Position of colon. *)
; CONST ItkROFormalType                 (*ArgCt: 2*) =   413 (*16_9d 03 *)
; CONST ItkROFormalTypeTemp             (*ArgCt: 2*) =   414 (*16_9e 03 *)
; CONST ItkROFormalTypePatch            (*ArgCt: 2*) =   415 (*16_9f 03 *)

(* Position of becomes, *)
; CONST ItkROFormalVal                  (*ArgCt: 2*) =   416 (*16_a0 03 *)
; CONST ItkROFormalValTemp              (*ArgCt: 2*) =   417 (*16_a1 03 *)
; CONST ItkROFormalValPatch             (*ArgCt: 2*) =   418 (*16_a2 03 *)
...
; CONST ItkExportIdListLt               (*ArgCt: 3*) =   419 (*16_a3 03 *)
; CONST ItkExportIdListLtTemp           (*ArgCt: 3*) =   420 (*16_a4 03 *)
; CONST ItkExportIdListLtPatch          (*ArgCt: 3*) =   421 (*16_a5 03 *)
; CONST ItkExportIdListRt               (*ArgCt: 3*) =   422 (*16_a6 03 *)

; CONST ItkExportIdListSep              (*ArgCt: 3*) =   423 (*16_a7 03 *)
; CONST ItkExportIdListSepTemp          (*ArgCt: 3*) =   424 (*16_a8 03 *)
; CONST ItkExportIdListSepPatch         (*ArgCt: 3*) =   425 (*16_a9 03 *)

; CONST ItkExportIdListElem             (*ArgCt: 3*) =   426 (*16_aa 03 *)
