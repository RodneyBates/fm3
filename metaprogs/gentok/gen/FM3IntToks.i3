...
; CONST ItkTypeDeclListLt               (*ArgCt: 3*) =   279 (*16_97 02 *)
; CONST ItkTypeDeclListLtTemp           (*ArgCt: 3*) =   280 (*16_98 02 *)
; CONST ItkTypeDeclListLtPatch          (*ArgCt: 3*) =   281 (*16_99 02 *)
; CONST ItkTypeDeclListRt               (*ArgCt: 3*) =   282 (*16_9a 02 *)

; CONST ItkTypeDeclListSep              (*ArgCt: 3*) =   283 (*16_9b 02 *)
; CONST ItkTypeDeclListSepTemp          (*ArgCt: 3*) =   284 (*16_9c 02 *)
; CONST ItkTypeDeclListSepPatch         (*ArgCt: 3*) =   285 (*16_9d 02 *)

; CONST ItkTypeDeclListElem             (*ArgCt: 3*) =   286 (*16_9e 02 *)

(* One field decl, with possibly multiple idents. *)
(* Position of LM ident (Lt) or position of semicolon (Rt). *)
(* FIXED ItkFieldDecl: *)
; CONST ItkFieldDeclLt                  (*ArgCt: 2*) =   287 (*16_9f 02 *)
; CONST ItkFieldDeclLtTemp              (*ArgCt: 2*) =   288 (*16_a0 02 *)
; CONST ItkFieldDeclLtPatch             (*ArgCt: 2*) =   289 (*16_a1 02 *)
; CONST ItkFieldDeclRt                  (*ArgCt: 2*) =   290 (*16_a2 02 *)

(* Position of colon. *)
; CONST ItkFieldDeclType                (*ArgCt: 2*) =   291 (*16_a3 02 *)
; CONST ItkFieldDeclTypeTemp            (*ArgCt: 2*) =   292 (*16_a4 02 *)
; CONST ItkFieldDeclTypePatch           (*ArgCt: 2*) =   293 (*16_a5 02 *)

(* Position of becomes. *)
; CONST ItkFieldDeclVal                 (*ArgCt: 2*) =   294 (*16_a6 02 *)
; CONST ItkFieldDeclValTemp             (*ArgCt: 2*) =   295 (*16_a7 02 *)
; CONST ItkFieldDeclValPatch            (*ArgCt: 2*) =   296 (*16_a8 02 *)

(* One variable decl, with possibly multiple idents. *)
(* Position of LM ident (Lt) or position of semicolon (Rt). *)
(* FIXED ItkVarDecl: *)
; CONST ItkVarDeclLt                    (*ArgCt: 2*) =   297 (*16_a9 02 *)
; CONST ItkVarDeclLtTemp                (*ArgCt: 2*) =   298 (*16_aa 02 *)
; CONST ItkVarDeclLtPatch               (*ArgCt: 2*) =   299 (*16_ab 02 *)
; CONST ItkVarDeclRt                    (*ArgCt: 2*) =   300 (*16_ac 02 *)

(* Position of colon. *)
; CONST ItkVarDeclType                  (*ArgCt: 2*) =   301 (*16_ad 02 *)
; CONST ItkVarDeclTypeTemp              (*ArgCt: 2*) =   302 (*16_ae 02 *)
; CONST ItkVarDeclTypePatch             (*ArgCt: 2*) =   303 (*16_af 02 *)

(* Position of becomes. *)
; CONST ItkVarDeclVal                   (*ArgCt: 2*) =   304 (*16_b0 02 *)
; CONST ItkVarDeclValTemp               (*ArgCt: 2*) =   305 (*16_b1 02 *)
; CONST ItkVarDeclValPatch              (*ArgCt: 2*) =   306 (*16_b2 02 *)

(* One formal, with possibly multiple idents. *)
(* Position of LM ident (Lt) or of semicolon (Rt). *)
(* FIXED ItkVALUEFormal: *)
; CONST ItkVALUEFormalLt                (*ArgCt: 2*) =   307 (*16_b3 02 *)
; CONST ItkVALUEFormalLtTemp            (*ArgCt: 2*) =   308 (*16_b4 02 *)
; CONST ItkVALUEFormalLtPatch           (*ArgCt: 2*) =   309 (*16_b5 02 *)
; CONST ItkVALUEFormalRt                (*ArgCt: 2*) =   310 (*16_b6 02 *)

(* Position of colon. *)
; CONST ItkVALUEFormalType              (*ArgCt: 2*) =   311 (*16_b7 02 *)
; CONST ItkVALUEFormalTypeTemp          (*ArgCt: 2*) =   312 (*16_b8 02 *)
; CONST ItkVALUEFormalTypePatch         (*ArgCt: 2*) =   313 (*16_b9 02 *)

(* Position of becomes. *)
; CONST ItkVALUEFormalVal               (*ArgCt: 2*) =   314 (*16_ba 02 *)
; CONST ItkVALUEFormalValTemp           (*ArgCt: 2*) =   315 (*16_bb 02 *)
; CONST ItkVALUEFormalValPatch          (*ArgCt: 2*) =   316 (*16_bc 02 *)

(* One formal, with possibly multiple idents. *)
(* Position of LM ident (Lt) or of semicolon (Rt). *)
(* FIXED ItkVARFormal: *)
; CONST ItkVARFormalLt                  (*ArgCt: 2*) =   317 (*16_bd 02 *)
; CONST ItkVARFormalLtTemp              (*ArgCt: 2*) =   318 (*16_be 02 *)
; CONST ItkVARFormalLtPatch             (*ArgCt: 2*) =   319 (*16_bf 02 *)
; CONST ItkVARFormalRt                  (*ArgCt: 2*) =   320 (*16_c0 02 *)

(* Position of colon. *)
; CONST ItkVARFormalType                (*ArgCt: 2*) =   321 (*16_c1 02 *)
; CONST ItkVARFormalTypeTemp            (*ArgCt: 2*) =   322 (*16_c2 02 *)
; CONST ItkVARFormalTypePatch           (*ArgCt: 2*) =   323 (*16_c3 02 *)

(* Position of becomes. *)
; CONST ItkVARFormalVal                 (*ArgCt: 2*) =   324 (*16_c4 02 *)
; CONST ItkVARFormalValTemp             (*ArgCt: 2*) =   325 (*16_c5 02 *)
; CONST ItkVARFormalValPatch            (*ArgCt: 2*) =   326 (*16_c6 02 *)

(* One formal, with possibly multiple idents. *)
(* Position of LM ident (Lt) or of semicolon (Rt). *)
(* FIXED ItkROFormal: *)
; CONST ItkROFormalLt                   (*ArgCt: 2*) =   327 (*16_c7 02 *)
; CONST ItkROFormalLtTemp               (*ArgCt: 2*) =   328 (*16_c8 02 *)
; CONST ItkROFormalLtPatch              (*ArgCt: 2*) =   329 (*16_c9 02 *)
; CONST ItkROFormalRt                   (*ArgCt: 2*) =   330 (*16_ca 02 *)

(* Position of colon. *)
; CONST ItkROFormalType                 (*ArgCt: 2*) =   331 (*16_cb 02 *)
; CONST ItkROFormalTypeTemp             (*ArgCt: 2*) =   332 (*16_cc 02 *)
; CONST ItkROFormalTypePatch            (*ArgCt: 2*) =   333 (*16_cd 02 *)

(* Position of becomes, *)
; CONST ItkROFormalVal                  (*ArgCt: 2*) =   334 (*16_ce 02 *)
; CONST ItkROFormalValTemp              (*ArgCt: 2*) =   335 (*16_cf 02 *)
; CONST ItkROFormalValPatch             (*ArgCt: 2*) =   336 (*16_d0 02 *)
...
; CONST ItkExportIdListLt               (*ArgCt: 3*) =   337 (*16_d1 02 *)
; CONST ItkExportIdListLtTemp           (*ArgCt: 3*) =   338 (*16_d2 02 *)
; CONST ItkExportIdListLtPatch          (*ArgCt: 3*) =   339 (*16_d3 02 *)
; CONST ItkExportIdListRt               (*ArgCt: 3*) =   340 (*16_d4 02 *)

; CONST ItkExportIdListSep              (*ArgCt: 3*) =   341 (*16_d5 02 *)
; CONST ItkExportIdListSepTemp          (*ArgCt: 3*) =   342 (*16_d6 02 *)
; CONST ItkExportIdListSepPatch         (*ArgCt: 3*) =   343 (*16_d7 02 *)

; CONST ItkExportIdListElem             (*ArgCt: 3*) =   344 (*16_d8 02 *)

(* Position is "(" *)
(* LIST ItkGenFormalIdList: *)
; CONST ItkGenFormalIdListLt            (*ArgCt: 3*) =   345 (*16_d9 02 *)
; CONST ItkGenFormalIdListLtTemp        (*ArgCt: 3*) =   346 (*16_da 02 *)
; CONST ItkGenFormalIdListLtPatch       (*ArgCt: 3*) =   347 (*16_db 02 *)
; CONST ItkGenFormalIdListRt            (*ArgCt: 3*) =   348 (*16_dc 02 *)

; CONST ItkGenFormalIdListSep           (*ArgCt: 3*) =   349 (*16_dd 02 *)
; CONST ItkGenFormalIdListSepTemp       (*ArgCt: 3*) =   350 (*16_de 02 *)
; CONST ItkGenFormalIdListSepPatch      (*ArgCt: 3*) =   351 (*16_df 02 *)

; CONST ItkGenFormalIdListElem          (*ArgCt: 3*) =   352 (*16_e0 02 *)

(* Position is "(" *)
(* LIST ItkGenActualIdList: *)
; CONST ItkGenActualIdListLt            (*ArgCt: 3*) =   353 (*16_e1 02 *)
; CONST ItkGenActualIdListLtTemp        (*ArgCt: 3*) =   354 (*16_e2 02 *)
; CONST ItkGenActualIdListLtPatch       (*ArgCt: 3*) =   355 (*16_e3 02 *)
; CONST ItkGenActualIdListRt            (*ArgCt: 3*) =   356 (*16_e4 02 *)

; CONST ItkGenActualIdListSep           (*ArgCt: 3*) =   357 (*16_e5 02 *)
; CONST ItkGenActualIdListSepTemp       (*ArgCt: 3*) =   358 (*16_e6 02 *)
; CONST ItkGenActualIdListSepPatch      (*ArgCt: 3*) =   359 (*16_e7 02 *)

; CONST ItkGenActualIdListElem          (*ArgCt: 3*) =   360 (*16_e8 02 *)

(* Position is is LM ident. *)
(* LIST ItkVarDeclIdList: *)
; CONST ItkVarDeclIdListLt              (*ArgCt: 3*) =   361 (*16_e9 02 *)
; CONST ItkVarDeclIdListLtTemp          (*ArgCt: 3*) =   362 (*16_ea 02 *)
; CONST ItkVarDeclIdListLtPatch         (*ArgCt: 3*) =   363 (*16_eb 02 *)
; CONST ItkVarDeclIdListRt              (*ArgCt: 3*) =   364 (*16_ec 02 *)

; CONST ItkVarDeclIdListSep             (*ArgCt: 3*) =   365 (*16_ed 02 *)
; CONST ItkVarDeclIdListSepTemp         (*ArgCt: 3*) =   366 (*16_ee 02 *)
; CONST ItkVarDeclIdListSepPatch        (*ArgCt: 3*) =   367 (*16_ef 02 *)

; CONST ItkVarDeclIdListElem            (*ArgCt: 3*) =   368 (*16_f0 02 *)

(* Position is LM ident . *)
(* LIST ItkTypeDeclIdList: *)
; CONST ItkTypeDeclIdListLt             (*ArgCt: 3*) =   369 (*16_f1 02 *)
; CONST ItkTypeDeclIdListLtTemp         (*ArgCt: 3*) =   370 (*16_f2 02 *)
; CONST ItkTypeDeclIdListLtPatch        (*ArgCt: 3*) =   371 (*16_f3 02 *)
; CONST ItkTypeDeclIdListRt             (*ArgCt: 3*) =   372 (*16_f4 02 *)

; CONST ItkTypeDeclIdListSep            (*ArgCt: 3*) =   373 (*16_f5 02 *)
; CONST ItkTypeDeclIdListSepTemp        (*ArgCt: 3*) =   374 (*16_f6 02 *)
; CONST ItkTypeDeclIdListSepPatch       (*ArgCt: 3*) =   375 (*16_f7 02 *)

; CONST ItkTypeDeclIdListElem           (*ArgCt: 3*) =   376 (*16_f8 02 *)

(* Position is "RECORD" *)
(* LIST ItkFieldDeclIdList: *)
; CONST ItkFieldDeclIdListLt            (*ArgCt: 3*) =   377 (*16_f9 02 *)
; CONST ItkFieldDeclIdListLtTemp        (*ArgCt: 3*) =   378 (*16_fa 02 *)
; CONST ItkFieldDeclIdListLtPatch       (*ArgCt: 3*) =   379 (*16_fb 02 *)
; CONST ItkFieldDeclIdListRt            (*ArgCt: 3*) =   380 (*16_fc 02 *)

; CONST ItkFieldDeclIdListSep           (*ArgCt: 3*) =   381 (*16_fd 02 *)
; CONST ItkFieldDeclIdListSepTemp       (*ArgCt: 3*) =   382 (*16_fe 02 *)
; CONST ItkFieldDeclIdListSepPatch      (*ArgCt: 3*) =   383 (*16_ff 02 *)

; CONST ItkFieldDeclIdListElem          (*ArgCt: 3*) =   384 (*16_80 03 *)

(* Position is "(" *)
(* LIST ItkFormalsList: *)
; CONST ItkFormalsListLt                (*ArgCt: 3*) =   385 (*16_81 03 *)
; CONST ItkFormalsListLtTemp            (*ArgCt: 3*) =   386 (*16_82 03 *)
; CONST ItkFormalsListLtPatch           (*ArgCt: 3*) =   387 (*16_83 03 *)
; CONST ItkFormalsListRt                (*ArgCt: 3*) =   388 (*16_84 03 *)

; CONST ItkFormalsListSep               (*ArgCt: 3*) =   389 (*16_85 03 *)
; CONST ItkFormalsListSepTemp           (*ArgCt: 3*) =   390 (*16_86 03 *)
; CONST ItkFormalsListSepPatch          (*ArgCt: 3*) =   391 (*16_87 03 *)

; CONST ItkFormalsListElem              (*ArgCt: 3*) =   392 (*16_88 03 *)

(* Position is VALUE or LM ident, if no mode. *)
(* LIST ItkVALUEFormalIdList: *)
; CONST ItkVALUEFormalIdListLt          (*ArgCt: 3*) =   393 (*16_89 03 *)
; CONST ItkVALUEFormalIdListLtTemp      (*ArgCt: 3*) =   394 (*16_8a 03 *)
; CONST ItkVALUEFormalIdListLtPatch     (*ArgCt: 3*) =   395 (*16_8b 03 *)
; CONST ItkVALUEFormalIdListRt          (*ArgCt: 3*) =   396 (*16_8c 03 *)

; CONST ItkVALUEFormalIdListSep         (*ArgCt: 3*) =   397 (*16_8d 03 *)
; CONST ItkVALUEFormalIdListSepTemp     (*ArgCt: 3*) =   398 (*16_8e 03 *)
; CONST ItkVALUEFormalIdListSepPatch    (*ArgCt: 3*) =   399 (*16_8f 03 *)

; CONST ItkVALUEFormalIdListElem        (*ArgCt: 3*) =   400 (*16_90 03 *)

(* Position is VAR. *)
(* LIST ItkVARFormalIdList: *)
; CONST ItkVARFormalIdListLt            (*ArgCt: 3*) =   401 (*16_91 03 *)
; CONST ItkVARFormalIdListLtTemp        (*ArgCt: 3*) =   402 (*16_92 03 *)
; CONST ItkVARFormalIdListLtPatch       (*ArgCt: 3*) =   403 (*16_93 03 *)
; CONST ItkVARFormalIdListRt            (*ArgCt: 3*) =   404 (*16_94 03 *)

; CONST ItkVARFormalIdListSep           (*ArgCt: 3*) =   405 (*16_95 03 *)
; CONST ItkVARFormalIdListSepTemp       (*ArgCt: 3*) =   406 (*16_96 03 *)
; CONST ItkVARFormalIdListSepPatch      (*ArgCt: 3*) =   407 (*16_97 03 *)

; CONST ItkVARFormalIdListElem          (*ArgCt: 3*) =   408 (*16_98 03 *)

(* Position is READONLY. *)
(* LIST ItkROFormalIdList: *)
; CONST ItkROFormalIdListLt             (*ArgCt: 3*) =   409 (*16_99 03 *)
; CONST ItkROFormalIdListLtTemp         (*ArgCt: 3*) =   410 (*16_9a 03 *)
; CONST ItkROFormalIdListLtPatch        (*ArgCt: 3*) =   411 (*16_9b 03 *)
; CONST ItkROFormalIdListRt             (*ArgCt: 3*) =   412 (*16_9c 03 *)

; CONST ItkROFormalIdListSep            (*ArgCt: 3*) =   413 (*16_9d 03 *)
; CONST ItkROFormalIdListSepTemp        (*ArgCt: 3*) =   414 (*16_9e 03 *)
; CONST ItkROFormalIdListSepPatch       (*ArgCt: 3*) =   415 (*16_9f 03 *)

; CONST ItkROFormalIdListElem           (*ArgCt: 3*) =   416 (*16_a0 03 *)

(* LIST ItkBlockDeclList: *)
; CONST ItkBlockDeclListLt              (*ArgCt: 3*) =   417 (*16_a1 03 *)
; CONST ItkBlockDeclListLtTemp          (*ArgCt: 3*) =   418 (*16_a2 03 *)
; CONST ItkBlockDeclListLtPatch         (*ArgCt: 3*) =   419 (*16_a3 03 *)
; CONST ItkBlockDeclListRt              (*ArgCt: 3*) =   420 (*16_a4 03 *)

; CONST ItkBlockDeclListSep             (*ArgCt: 3*) =   421 (*16_a5 03 *)
; CONST ItkBlockDeclListSepTemp         (*ArgCt: 3*) =   422 (*16_a6 03 *)
; CONST ItkBlockDeclListSepPatch        (*ArgCt: 3*) =   423 (*16_a7 03 *)

; CONST ItkBlockDeclListElem            (*ArgCt: 3*) =   424 (*16_a8 03 *)

(* Statements *)
(* LIST ItkStmtList: *)
; CONST ItkStmtListLt                   (*ArgCt: 3*) =   425 (*16_a9 03 *)
; CONST ItkStmtListLtTemp               (*ArgCt: 3*) =   426 (*16_aa 03 *)
; CONST ItkStmtListLtPatch              (*ArgCt: 3*) =   427 (*16_ab 03 *)
; CONST ItkStmtListRt                   (*ArgCt: 3*) =   428 (*16_ac 03 *)

; CONST ItkStmtListSep                  (*ArgCt: 3*) =   429 (*16_ad 03 *)
; CONST ItkStmtListSepTemp              (*ArgCt: 3*) =   430 (*16_ae 03 *)
; CONST ItkStmtListSepPatch             (*ArgCt: 3*) =   431 (*16_af 03 *)

; CONST ItkStmtListElem                 (*ArgCt: 3*) =   432 (*16_b0 03 *)

(* FIXED ItkBecomes: *)
; CONST ItkBecomesLt                    (*ArgCt: 2*) =   433 (*16_b1 03 *)
; CONST ItkBecomesLtTemp                (*ArgCt: 2*) =   434 (*16_b2 03 *)
; CONST ItkBecomesLtPatch               (*ArgCt: 2*) =   435 (*16_b3 03 *)
; CONST ItkBecomesRt                    (*ArgCt: 2*) =   436 (*16_b4 03 *)

(* Position of infix token, x3. *)
; CONST ItkBecomesInfix                 (*ArgCt: 2*) =   437 (*16_b5 03 *)
; CONST ItkBecomesInfixTemp             (*ArgCt: 2*) =   438 (*16_b6 03 *)
; CONST ItkBecomesInfixPatch            (*ArgCt: 2*) =   439 (*16_b7 03 *)
